...
Mass1 = 100 * C.am; % Argon green balls
...
AddElipticalAtomicArray(10, 6, 0, 0, 0, 0, 0, T, 0)
% vy0 = -sqrt(0.02*Ep/Mass1);
% AddRectAtomicArray(4,4,0,12*AtomSpacing,0,vy0,0,T,1);
Ep = 15;%speed of Argon balls
% created two streams 
AddParticleStream(15, 0.7, -10, pi / 2, 1, Ep * C.q_0, 5);
AddParticleStream(15, 4, 10, -pi / 2, 2, Ep * C.q_0, 5);
AddParticleStream(15, 0, 0, 0, 1, Ep * C.q_0, 5);
